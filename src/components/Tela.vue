    ...
    <div class="urna-tela">
        <div v-if="tela!= 'fim'" class="urna-tela-voto">
            <div class="urna-tela-voto-textos">
                ...
                <div class="urna-tela-voto-numeros">
                 ...
                 <div class="urna-tela-voto-descricao">
                    Nome: <strong> {{ candidato.nome ? candidato.nome : '_______________' }} </strong>
                </div>
                <div class="urna-tela-voto-descricao">
                    Pais: <strong> {{ candidato.pais ? candidato.pais : '_______________' }} </strong>
                </div>
            </div>
            ...
            <div class="urna-tela-voto-instrucoes">
                <p>Aperte a tecla:</p>
                <p>BRANCO para VOTO NULO </p>
                <p>CORRIGE para CORRIGIR</p>
                <p>CONFIRMAR para CONFIRMAR VOTOS</p>
            </div>
        </div>
